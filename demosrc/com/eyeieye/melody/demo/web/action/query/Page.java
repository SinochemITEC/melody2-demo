package com.eyeieye.melody.demo.web.action.query;
...
import com.eyeieye.melody.demo.query.UserQuery;
import com.eyeieye.melody.demo.web.action.PageSlider;

@Controller
@RequestMapping("/query")
public class Page {
	@RequestMapping("/form_page.htm")
